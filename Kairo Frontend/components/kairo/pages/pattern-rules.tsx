  ...
  return (
    <div className="rounded-lg border border-border bg-background p-5">
      ...
      <div className="mb-3 flex items-start justify-between">
        <div>
          <h3 className="text-[14px] font-semibold text-foreground">{pattern.name}</h3>
          <span className="text-[12px] text-muted-foreground">{pattern.vendor}</span>
        </div>
      </div>
      ...
      <div className="mb-4">
        <div className="mb-1 flex items-center justify-between">
          ...
          <span className="text-[24px] font-bold text-foreground">{pattern.confidence}%</span>
        </div>
      ...
      <div className="mb-4 flex items-center justify-between text-[12px]">
        <span className="text-muted-foreground">
          Fired <span className="font-medium text-foreground">{pattern.triggerCount}</span> times
        </span>
        <span className="text-muted-foreground">
          Last: <span className="font-medium text-foreground">{pattern.lastFired}</span>
        </span>
      </div>

      {/* Condition */}
      <div className="mb-4 rounded-md bg-muted/50 p-3">
        <p className="font-mono text-[11px] text-muted-foreground">{pattern.condition}</p>
      </div>

      {/* Action */}
      <button className="flex items-center gap-1 text-[12px] font-medium text-accent hover:underline">
        View incidents
